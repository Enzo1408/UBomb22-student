...
public class MapLevelDefault extends MapLevel {
    private final static Entity[][] level1 = {
            {Empty, Monster, Empty, Empty, Empty, Empty, Empty, Empty, Monster, Empty, Empty, Empty},
            ...
            {Empty, Empty, Empty, Empty, Stone, Princess, Stone, Empty, Empty, Stone, Empty, Empty},
            ...
            {Empty, Empty, Empty, Empty, Empty, Empty, Empty, Empty, Empty, Empty, Empty, Empty},
            {Empty, Monster, Empty, Empty, Empty, Empty, Empty, Empty, Empty, Empty, Empty, Box}
    };
